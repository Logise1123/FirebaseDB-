    ...
    class FirebaseDB {
        ...
        getInfo() {
            return {
                ...
                menuIconURI: icon,
                blocks: [
                    // New block to set the database URL
                    {
                        ...
                        arguments: {
                            URL: {
                                ...
                                defaultValue: "https://guessthepin-2fe64-default-rtdb.europe-west1.firebasedatabase.app"
                            }
                        }
                    },
                    // Existing extension blocks
        ...
        // New method to update the database URL
        setDatabaseURL(args) {
            const { URL } = args;
            this.api = URL;
        }
